...
// Riverpod: ConsumerWidget for StatelessWidget
class _LoginForm extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final loginForm = ref.watch(loginFormProvider); // state: LoginFormState

    // listen that provider
      ...
      child: Column(
        children: [
          ...
          CustomTextFormField(
            ...
            // .read in methods/Listeners/events, etc.
          ...
          CustomTextFormField(
            ...
            // onSubmit with done in this field
            onFieldSubmitted: (_) => ref.read(loginFormProvider.notifier).onSubmit(),
